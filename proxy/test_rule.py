...
class TestPathStartsWith:
    def test_matching_prefix(self):
        r = rule.path_starts_with("/api/metrics").then("deny")
    ...
    def test_multiple_prefixes(self):
        r = rule.path_starts_with("/foo", "/bar").then("deny")
...
class TestChaining:
    def test_method_and_path(self):
        r = rule.method_one_of(["post"]).path_starts_with("/api").then("deny")
